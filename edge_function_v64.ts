...
const DEPLOY_VERSION = 'v64-phase9.2';
...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    if (mode === 'india-macro') {
      ...
      const [gdp, pfce, gfcf, iipRes, cpi, wpi, repo, gsec10, tbill3m, bankCreditRes, depositsRes, tradeBalanceRes, fxReservesRes, brentSeries, niftySeries, niftyAutoSeries, systemRoe, sectorBenchmarks] = await Promise.all([
